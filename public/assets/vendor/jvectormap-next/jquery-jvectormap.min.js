...
Array.prototype.indexOf ||
            ...
            ? ("object" == typeof value
              ...
              jvm.whenImageLoaded(imageUrl).then(function (img) {
                  that.node.setAttributeNS(
                      ...
                      that.applyAttr(
                          "x",
                          that.cx - that.width / 2 + that.offset[0]
                      ),
                      that.applyAttr(
                          "y",
                          that.cy - that.height / 2 + that.offset[1]
                      ),
    ...
    (jvm.VectorCanvas = function (container, width, height) {
        return (
            ...
            "svg" == this.mode
                ? (this.impl = new jvm.SVGCanvasElement(
                      container,
                      width,
                      height
                  ))
                : (this.impl = new jvm.VMLCanvasElement(
                      container,
                      width,
                      height
                  )),
